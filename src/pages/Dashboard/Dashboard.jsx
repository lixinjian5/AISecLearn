    ...
    <div className="space-y-8 p-6">
          ...
          <div className="rounded-2xl bg-gray-900/60 border border-gray-800/30 p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-gray-800/20 hover:border-gray-700/40 cursor-pointer transition-colors"
                >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FadeContent blur={true} duration={600} delay={800}>
          <SpotlightCard
            className="!rounded-2xl !p-6 !bg-gray-900/60 !border-gray-800/30"
            ...
            <div className="h-40 flex items-end justify-between gap-2 px-2">
              {[35, 42, 28, 55, 48, 62, 68].map((h, i) => (
                <div key={i} className="flex-1 flex flex-col items-center gap-2">
                  <div
                    className="w-full rounded-t-md bg-gradient-to-t from-primary-600/60 to-cyber-500/40 transition-all hover:from-primary-500 hover:to-cyber-400"
                    style={{ height: `${h}%` }}
                  />
            ...
            <div className="space-y-2">
              {[
                ...
                <div
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-gray-800/20 hover:border-gray-700/40 cursor-pointer transition-colors"
                >
                  <span className="w-6 h-6 rounded-lg bg-red-500/10 flex items-center justify-center text-red-400 text-xs shrink-0">
                    ✕
                  </span>
                  <div className="flex-1 min-w-0">
